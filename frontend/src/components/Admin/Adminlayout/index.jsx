...
const items = [
  { key: "/app/admin/dashboard", label: "Dashboard", icon: <AppstoreAddOutlined /> },
  { key: "/app/admin/report", label: "Reports", icon: <BarChartOutlined /> },
  { key: "/app/admin/users", label: "Users", icon: <UserOutlined /> },
];
